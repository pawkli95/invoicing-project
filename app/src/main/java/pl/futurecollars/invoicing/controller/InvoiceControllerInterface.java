...
public interface InvoiceControllerInterface {
    ...
    @PostMapping
    ResponseEntity<InvoiceDto> saveInvoice(@RequestBody InvoiceDto invoice) throws ConstraintException;
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<Void> delete(@PathVariable UUID id) throws NoSuchElementException, ConstraintException;
}
